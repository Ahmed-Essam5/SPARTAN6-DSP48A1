...
HD_PWD='D:/Extra/Vivado_Kareem_Waseem/DSP48A1_Project1/DSP48A1_Project1/DSP48A1_Project1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1_Project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP48A1_Project.tcl -notrace
