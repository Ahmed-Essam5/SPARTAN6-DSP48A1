...
HD_PWD='D:/Extra/Vivado_Kareem_Waseem/DSP48A1_Project1/DSP48A1_Project1/DSP48A1_Project1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1_Project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP48A1_Project.tcl
